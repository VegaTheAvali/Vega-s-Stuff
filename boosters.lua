...
SMODS.Booster {
    ...
    loc_txt = {
        name = "Geomancy Pack",
        text = {
            [1] = 'Choose up to {C:attention}1{} of {C:attention}3{} Geomancy cards'
        },
        group_name = "vegasstuff_boosters"
    },
    config = { extra = 3, choose = 1 },
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_geomancy_pack"
        }
    end,
    ease_background_colour = function(self)
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_geomancy_pack2"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_geomancy_pack3"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_geomancy_pack4"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    key = 'jumbo_geomancy_pack',
    loc_txt = {
        name = "Jumbo Geomancy Pack",
        text = {
            [1] = 'Choose up to {C:attention}1{} of {C:attention}5{} Geomancy cards'
        },
        group_name = "vegasstuff_boosters"
    },
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_jumbo_geomancy_pack"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_jumbo_geomancy_pack2"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    key = 'mega_geomancy_pack',
    loc_txt = {
        name = "Mega Geomancy Pack",
        text = {
            [1] = 'Choose up to {C:attention}2{} of {C:attention}5{} Geomancy cards'
        },
        group_name = "vegasstuff_boosters"
    },
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_mega_geomancy_pack"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_mega_geomancy_pack2"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    key = 'mini_geomancy_pack',
    loc_txt = {
        name = "Mini Geomancy Pack",
        text = {
            [1] = 'Choose up to {C:attention}1{} of {C:attention}2{} Geomancy cards'
        },
        group_name = "vegasstuff_boosters"
    },
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_mini_geomancy_pack"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
...
SMODS.Booster {
    ...
    create_card = function(self, card, i)
        return {
            ...
            skip_materialize = true,
            soulable = true,
            key_append = "vegasstuff_mini_geomancy_pack2"
        }
    end,
    ease_background_colour = function(self)
        ease_colour(G.C.DYN_UI.MAIN, HEX("49006d"))
