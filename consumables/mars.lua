...
SMODS.Consumable {
    ...
    loc_txt = {
        ...
        text = {
            [1] = 'All cards gain {C:red}+#1#{} permanent Mult',
            [2] = '{C:inactive}(Level #2#/#4#, Total +#3# Mult){}'
        }
    },
    cost = 3,
    unlocked = true,
    ...
    loc_vars = function(self)
        ...
        return { vars = { next_gain, next_level, total_deck_stat_gain(self, next_level), extra.max_level } }
    end,
